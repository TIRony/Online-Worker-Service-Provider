...
$firstName = $lastName = $email = $phone = $DOB = $NID = $address = "";

$sqlUserCheck = "SELECT CID,firstName, lastName, userName, email, phone, NID, address, DOB FROM customer WHERE userName = '$username'";
      ...
      <div class="container">
        ...
        <nav>
          <ul>
            ...
            <li class="current"><a href="CustomerAccountInfo.php">My Account Information</a></li><br><br><br>
...
<section id="LoginSignupbar">
       <div class="container">
         <aside id="Signupbar">
                ...
                <div>
                    <button type="submit" class="Signup" name="updateButton">Update</button><br>
