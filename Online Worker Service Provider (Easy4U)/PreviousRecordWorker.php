...
if(isset($_POST['searchButton'])){
  ...
  $sqlUser="SELECT WID FROM worker where userName='$username';";
  $resultCID=mysqli_query($conn, $sqlUser);
  while($rowCID=mysqli_fetch_assoc($resultCID))
                    {
                      $CID = $rowCID['WID'];
                    }
  $sqlUserCheck="SELECT * FROM history where WID='$CID' LIMIT $startingRow, $perPage;";
      ...
      <div class="container">
        ...
        <nav>
          <ul>
            ...
            <li class="current"><a href="PreviousRecordWorker.php">Prevoius Record</a></li><br><br>
...
<form id="loadCustomer" action="PrevoiusRecordWorker.php" method="post">
