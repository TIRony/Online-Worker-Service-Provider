...
if(isset($_POST['searchButton'])){
  ...
  $sqlUserCheck="SELECT * FROM dept LIMIT $startingRow, $perPage;";
  $result=mysqli_query($conn, $sqlUserCheck);
  //$row=mysqli_num_rows($result);
}
  $sqlRowCount="SELECT * FROM dept";
      ...
      <div class="container">
        ...
        <nav>
          <ul>
            ...
            <li class="current"><a href="AddDepartment.php">Department</a></li><br><br>
...
<form id="loadCustomer" action="AddDepartment.php" method="post">
     <section id="Customerload">
        ...
        <aside id="load">
             <h2><span class="highlight">Hello</span>, <?php echo $username ?> <h2>
              ...
              <table id="show" class="tableLayout" style="width: 100%">
                <thead>
                <th><h2>DID</h2></th>
                <th><h2>Department Name to</h2></th>
                <th><h2>Rate</h2></th>
       ...
       <div id="buttonpg">
       <a href="AddDepartment.php?prev=<?php echo $a-1; ?>" class="buttonpg">Previous</a>
       <?php
      for($i=1; $i<=$totalPage; $i++){ ?>
       <a href="AddDepartment.php?pg=<?php echo $i; ?>" class="buttonpg"><?php echo $i; ?></a>
       <?php
      }
      ?>
       <a href="AddDepartment.php?next=<?php echo $a+1; ?>" class="buttonpg">Next</a>
     </div>
       ...
       <aside id="loadUpdate">
                ...
                <div>
                    <label>DID </label>
                    <input readonly="" type="text" name="DID" id="DID">
                </div>
                <div>
