      ...
      <div class="container">
        ...
        <nav>
          <ul>
            ...
            <li class="current"><a href="loadWorker.php">Worker</a></li><br><br>
...
<form id="loadCustomer" action="" method="post">
     <section id="Customerload">
       ...
       <div id="buttonpg">
       <a href="loadWorker.php?prev=<?php echo $a-1; ?>" class="buttonpg">Previous</a>
       <?php
      for($i=1; $i<=$totalPage; $i++){ ?>
       <a href="loadWorker.php?pg=<?php echo $i; ?>" class="buttonpg"><?php echo $i; ?></a>
       <?php
      }
      ?>
       <a href="loadWorker.php?next=<?php echo $a+1; ?>" class="buttonpg">Next</a>
     </div>
