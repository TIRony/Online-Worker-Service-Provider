...
if(isset($_POST['searchButton'])){
  ...
  $sqlUser="SELECT CID FROM customer where userName='$username';";
  $resultCID=mysqli_query($conn, $sqlUser);
  while($rowCID=mysqli_fetch_assoc($resultCID))
                    {
                      $CID = $rowCID['CID'];
                    }
  $sqlUserCheck="SELECT * FROM history where CID='$CID' LIMIT $startingRow, $perPage;";
      ...
      <div class="container">
        ...
        <nav>
          <ul>
            ...
            <li class="current"><a href="PreviousRecordCustomer.php">Prevoius Record</a></li><br><br>
...
<form id="loadCustomer" action="PrevoiusRecordCustomer.php" method="post">
