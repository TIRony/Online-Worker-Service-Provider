    ...
    $RIDToSearch = "Ss".$rowRequestDelete['RID'];
              ...
              if(isset($_POST[$RIDToSearch])){
                      ...
                      $resultRequestAssignWorker=mysqli_query($conn, $sqlRequestSetWorker);
                          ...
                          if(isset($_POST['assignWorkerButton'])){
                            $sqlConfirmAssign = "UPDATE assignworker SET Assign= 1";
      ...
      <div class="container">
        ...
        <nav>
          <ul>
            ...
            <li class="current"><a href="Employee.php">My Account</a></li><br><br>
          </div>
...
<form id="loadCustomer" action="Employee.php" method="post">
